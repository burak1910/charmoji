...
// Zaten giriş yapılmışsa userpage'e at
...
<head>
    ...
    <style>
        ...
        .blob-2 { bottom: 5%; right: 10%; animation-delay: 2s; }
    </style>
</head>
<body class="bg-gray-50 text-gray-800 dark:bg-dark-bg dark:text-gray-200 transition-colors duration-300 min-h-screen flex flex-col font-sans">
    ...
    <main class="flex-grow flex items-center justify-center relative px-4 py-24">
        ...
        <div class="w-full max-w-lg bg-white dark:bg-dark-card rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8 relative z-10 transition-colors duration-300">
            
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Aramıza Katıl</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">Yeni bir hesap oluşturarak Charmoji dünyasına adım at.</p>
            </div>
            ...
            <form action="../service/auth.php" method="POST" class="space-y-5">
                ...
                <div>
                    <label for="fullname" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Ad Soyad</label>
                    <div class="relative">
                ...
                <div>
                    <label for="confirm_password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Şifre Tekrarı</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                ...
                <button type="submit" 
                    class="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-primary hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all transform hover:-translate-y-0.5 mt-2">
                    Hesap Oluştur
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <a href="login.php" class="font-semibold text-primary hover:text-primary-hover hover:underline transition-colors">
                        Giriş Yap
                    </a>
                </p>
            </div>
